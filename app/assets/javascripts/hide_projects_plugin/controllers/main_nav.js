 ...
 */
Application.Controllers.controller('MainNavController', ['$scope', '$rootScope', 'settingsPromise', 'AuthService', 'Auth', function ($scope, $rootScope, settingsPromise, AuthService, Auth) {
  /**
